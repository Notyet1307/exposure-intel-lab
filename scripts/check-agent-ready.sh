...
require_contains .github/workflows/deepseek-pr-review.yml "contents: read"
require_contains .github/workflows/deepseek-pr-review.yml "pull-requests: write"
require_contains .github/workflows/deepseek-pr-review.yml "uses: actions/checkout@v5"
