...
require_contains .github/workflows/deepseek-pr-review.yml "pull-requests: read"
require_not_contains .github/workflows/deepseek-pr-review.yml "pull-requests: write"
